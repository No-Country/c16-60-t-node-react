...
const CartPage = () => {
  ...
  return (
    <main className="flex lg:flex-row flex-col justify-center items-start gap-5 mx-auto lg:px-0 pt-16 pb-10 max-w-screen-xl h-[calc(100vh-75px)]">
      <section className="flex-1">
        <Link href={"/products"} className="font-medium text-base underline">
          Continuar Comprando
        </Link>
        <h2 className="my-2 font-semibold text-3xl text-gray-800">My Carrito de compras</h2>
        <span>Tienes .... productos en tu carrito</span>
