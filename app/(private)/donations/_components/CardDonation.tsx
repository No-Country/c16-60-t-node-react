...
export const CardDonation = () => {
  return (
    <div className="md:flex justify-center items-start bg-white shadow-lg py-24 2xl:py-32 rounded-xl">
      <div className="w-full md:w-1/2">
        ...
        <p className="font-medium text-base text-center text-gray-600 sm:text-base lg:text-left lg:text-xl">
