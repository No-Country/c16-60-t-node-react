...
const Home = () => {
  return (
    <section className='container flex gap-9  flex-col lg:flex-row h-[800px] lg:h-[500px]  py-10'>
      <div className='flex flex-col justify-center gap-9 flex-1 pr-9'>
        <h1 className='text-5xl lg:text-6xl font-bold text-center lg:text-left'>
          Smart Help: donaciones que{" "}
          <span className='text-violet-700'>impactan</span>.
        </h1>
        <p className='text-gray-600  text-justify lg:text-left '>
