...
export const products: ProductsData[] = [
  ...
  {
    id: 2,
    image: "https://http2.mlstatic.com/D_NQ_NP_854782-MLA51796683268_102022-O.webp",
    name: "Six Pack de agua x 2 lts",
    category: Category.BEBIDA,
    price: 135,
    quantity: 20,
    description:
      "El six pack de agua de 2 litros ofrece conveniencia y frescura en cada botella. Con su práctico formato, es ideal para mantenerse hidratado en casa, en el trabajo o en movimiento. Cada botella está sellada herméticamente para garantizar la pureza del agua, proporcionando una fuente confiable de hidratación. Perfecto para compartir con la familia o llevarlo en actividades al aire libre. Este pack de seis unidades es una opción económica y ecológica, reduciendo el consumo de plástico individual. Con su tamaño generoso y calidad premium, es la opción ideal para satisfacer la sed de forma conveniente y saludable.",
  },
  {
    id: 3,
